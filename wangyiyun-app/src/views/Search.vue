<template>
  ...
  <div class="searchhistory">
    ...
    <span class="spanKey" v-for="item in keyWorldList" :key="item" @click="searchHistory(item)">{{ item }}</span>
...
export default {
    ...
    mounted(){this.keyWorldList = JSON.parse(localStorage.getItem("keyWorldList"))||[]},
    methods:{
